...
- [Browser Automation CLI/socket 规格设计](docs/09-browser-automation-cli-socket-spec.md)
- [Socket 安全模式、trusted cwd 与 token 规格](docs/10-socket-security-trusted-cwd-token.md)
- [cmux 对齐优化清单](docs/11-cmux-gap-optimization.md)
- [Warp 风格终端体验升级 PRD](docs/12-warp-inspired-terminal-enhancement.md)
