...
- `npm run smoke:browser` 覆盖 socket 安全模式、terminal 链接内置 browser、browser automation navigate/list/snapshot/selector snapshot/fill/click/eval/console/errors/cookies/storage/state inspection/screenshot、ambiguous target 和写文件路径校验。
